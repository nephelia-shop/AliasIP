...
namespace fenomeno\AliasIP\libs\poggit\libasynql;

use fenomeno\AliasIP\libs\poggit\libasynql\base\DataConnectorImpl;
use fenomeno\AliasIP\libs\poggit\libasynql\base\SqlThreadPool;
use fenomeno\AliasIP\libs\poggit\libasynql\mysqli\MysqlCredentials;
use fenomeno\AliasIP\libs\poggit\libasynql\mysqli\MysqliThread;
use fenomeno\AliasIP\libs\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		self::$packaged = __CLASS__ !== 'fenomeno\AliasIP\libs\poggit\libasynql\libasynql';
